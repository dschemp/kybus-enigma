...
namespace KybusEnigma.XUnit
{
    public class UnitTestSha2
    {
        ...
        public byte[] Text2Bytes(string msg) => System.Text.Encoding.UTF8.GetBytes(msg);
        ...
        {
            var data = Text2Bytes("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq");
        ...
        {
            var data = Text2Bytes("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu");
        ...
        {
            var data = Text2Bytes(new string('a', 1_000_000));
